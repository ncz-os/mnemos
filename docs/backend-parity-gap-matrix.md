...
Generated by scripts/backend_gap_matrix.py (await-based classifier: IMPL=does real async work, STUB=returns constant, RAISE=NotImplementedError, absent=class lacks the method). 2026-06-13.
...
| method | oracle | postgres | db2 | mysql | sqlite |
|---|---|---|---|---|---|
| resolve_tier_lineup | STUB | IMPL | -- | IMPL | IMPL |
| resolve_models | STUB | IMPL | -- | IMPL | IMPL |
| create_consultation_with_audit | IMPL | IMPL | RAISE | IMPL | IMPL |
| list_audit_log | STUB | IMPL | -- | -- | IMPL |
| fetch_audit_chain | STUB | IMPL | -- | -- | IMPL |
| get_consultation | STUB | IMPL | -- | -- | IMPL |
| get_consultation_artifacts | STUB | IMPL | -- | -- | IMPL |
