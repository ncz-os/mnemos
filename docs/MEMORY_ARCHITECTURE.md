...
external surface contract) and `ROADMAP.md` (forward-looking scope).
...
content is incremental. As of v7.0.0.dev0:
...
*v1.0 — 2026-05-08. Tracks MNEMOS server v7.0.0.dev0*
