...
**Cost benefit:**
- Reduces `pgvector` index bloat (10–15% reduction on the primary production sample).
...
- ✅ Live the primary production: archival job runs nightly without incidents; archival volume > 100k memories.
...
- [ ] PERSEPHONE S3 restore validated on operator's prod infrastructure (or the primary test).
