...
reasoning that got us from the original prototype to the current v5.0.1 release line. If you
...
- **APOLLO** (gpu_optional) — schema-aware dense encoding for
  ...
  commit schemas as of v6.0.0rc1 LLM-fallback path covers anything that
