...
-- Mirrors db/migrations_v4_2_pantheon_routing_audit.sql so the optional
-- PANTHEON routing-audit consumer has a dedicated table instead of falling
-- back to memories-backed telemetry.
