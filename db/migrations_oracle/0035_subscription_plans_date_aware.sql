...
WHERE provider = 'anthropic'
  AND plan_name = 'claude_max_200_pre_jun1';

-- seed as per task: claude_max_100_post_jun1 etc.
MERGE INTO subscription_plans dst
USING (
  SELECT 'anthropic' provider, 'claude_max_200_pre_jun1' plan_name, 'subscription' auth_method,
         200 monthly_usd, 375 msg_cap, 18000 msg_window_seconds,
         ...
         'Anthropic Claude Max 200 pre-Jun1' notes,
         DATE '2026-04-01' effective_from, DATE '2026-05-31' effective_until,
         'interactive' path_kind, NULL parent_plan_id FROM dual
  UNION ALL SELECT 'anthropic', 'claude_max_100_post_jun1', 'subscription',
         100, 225, 18000, NULL, NULL, 'rolling', NULL, NULL,
         'Claude Max 100 post Jun1 parent claude_max_200', DATE '2026-06-01', DATE '2026-06-14', 'interactive', 'claude_max_200' FROM dual
  UNION ALL SELECT 'anthropic', 'claude_max_interactive_post_jun15', 'subscription',
         100, 225, 18000, NULL, NULL, 'rolling', NULL, NULL,
         'Claude Max interactive post Jun15', DATE '2026-06-15', NULL, 'interactive', 'claude_max_100_post_jun1' FROM dual
  UNION ALL SELECT 'anthropic', 'agent_sdk_credit_pool_post_jun15', 'subscription',
         0, NULL, NULL, NULL, NULL, 'monthly', NULL, NULL,
         'Agent SDK credit pool post Jun15', DATE '2026-06-15', NULL, 'sdk_credit_pool', 'claude_max_100_post_jun1' FROM dual
  UNION ALL SELECT 'xai', 'supergrok_post_may19', 'subscription',
         30, NULL, NULL, NULL, NULL, 'monthly', NULL, NULL,
         'xAI SuperGrok interactive /mo', DATE '2026-05-19', NULL, 'interactive', NULL FROM dual
) src
