...
BEGIN
  ...
  EXECUTE IMMEDIATE '
    CREATE TABLE hive_jobs (
      ...
      deadline                 DOUBLE,
      required_capabilities    CLOB(1M),
      eligible_kinds           CLOB(1M),
      ...
      preferred_providers      CLOB(1M),
      preferred_models         CLOB(1M),
      ...
      required_resources       CLOB(1M),
      claimed_host_caps        CLOB(1M),
      project                  VARCHAR(64),
      tags                     CLOB(1M),
      depends_on               CLOB(1M),
