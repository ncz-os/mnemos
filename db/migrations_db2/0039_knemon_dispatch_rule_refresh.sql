...
USING (
  VALUES
    ...
    ('openai', 'chatgpt_pro', 'subscription', 200, NULL, NULL, NULL, NULL,
     'monthly', NULL, NULL, 'ChatGPT Pro $200: legacy/default row; unlimited Pro-model access subject to abuse guardrails',
     DATE('2026-05-28'), NULL, 'unmetered', NULL),
    ('openai', 'chatgpt_pro_100', 'subscription', 100, NULL, NULL, NULL, NULL,
     'monthly', NULL, NULL, 'ChatGPT Pro $100: unlimited Pro-model access subject to abuse guardrails; 5x Plus overall Pro tier',
     DATE('2026-05-28'), NULL, 'unmetered', NULL),
    ('openai', 'chatgpt_pro_200', 'subscription', 200, NULL, NULL, NULL, NULL,
     'monthly', NULL, NULL, 'ChatGPT Pro $200: unlimited Pro-model access subject to abuse guardrails; 20x Plus overall Pro tier',
     DATE('2026-05-28'), NULL, 'unmetered', NULL),
    ('openai', 'codex_plus', 'subscription', 20, 15, 18000, NULL, NULL,
     'rolling', NULL, NULL, 'Codex Plus GPT-5.5 planning cap: 15 lower bound of published 15-80 messages per 5h',
     DATE('2026-05-28'), NULL, 'interactive', NULL),
    ('openai', 'codex_pro_100_10x', 'subscription', 100, 160, 18000, NULL, NULL,
     'rolling', NULL, NULL, 'Codex Pro $100 launch promo planning cap: 160 lower bound of 160-800 messages per 5h through 2026-05-31',
     DATE('2026-05-28'), DATE('2026-05-31'), 'interactive', 'codex_pro_100'),
    ('openai', 'codex_pro_100_5x', 'subscription', 100, 80, 18000, NULL, NULL,
     'rolling', NULL, NULL, 'Codex Pro $100 planning cap: GPT-5.5 5x lower bound of 80-400 messages per 5h from 2026-06-01',
     DATE('2026-06-01'), NULL, 'interactive', 'codex_pro_100'),
    ('openai', 'codex_pro_200_25x', 'subscription', 200, 375, 18000, NULL, NULL,
     'rolling', NULL, NULL, 'Codex Pro $200 temporary 25x planning cap: 375 lower bound of 375-2000 messages per 5h through 2026-05-31',
     DATE('2026-05-28'), DATE('2026-05-31'), 'interactive', 'codex_pro_200'),
    ('openai', 'codex_pro_200_20x', 'subscription', 200, 300, 18000, NULL, NULL,
     'rolling', NULL, NULL, 'Codex Pro $200 planning cap: GPT-5.5 20x lower bound of 300-1600 messages per 5h from 2026-06-01',
