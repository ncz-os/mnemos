...
_MIGRATION_GROUP_BY_NAME: dict[str, str] = {
    ...
    "migrations_v5_4_1_morpheus_extract_failures.sql": "morpheus",
...
def run_migrations(config: Config) -> bool:
    ...
    migration_files = [
        repo_path / "mnemos" / "db_migrations" / "migrations.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v1_multiuser.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v2_versioning.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v2_sessions.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_model_registry.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_dag.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_graeae_unified.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_webhooks.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_oauth.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_federation.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_ownership.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_1_compression.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_1_versioning_fix.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_1_2_kg_tenancy.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_1_2_audit_log_columns.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_2_user_namespace.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_2_entities_namespace.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_2_2_version_snapshot_new_values.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_3_morpheus.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_3_morpheus_namespace.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_3_recall_tracking.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_charon_trigger_guard.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_4_federation_compat.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_5_trigger_same_memory_parent.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_5_rls_group_select_unix_bits.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_5_webhook_retry_terminal_state.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_5_webhook_attempt_lease.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_5_webhook_writer_revision.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_5_webhook_status_updated_at.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_5_webhook_superseded_marker.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_5_webhook_attempt_unique.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_5_webhook_succeeded_unique.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_5_webhook_succeeded_terminal_trigger.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_5_entities_namespace_unique.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_5_state_journal_namespace.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_5_session_compression_ratio_drop.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_5_session_compression_legacy_drop.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v3_5_sessions_consultations_namespace.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v4_2_users_username.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v4_2_compression_candidates_nullable_tokens.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v4_2_state_value_text.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v4_2_document_import_chunk_idempotency.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v4_2_deletion_requests.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v4_2_deletion_requests_blank_namespace_cleanup.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v4_2_deletion_requests_soft_delete_columns.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v4_2_deletion_requests_sweep_verifying.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v4_2_compression_dag.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v4_2_morpheus_consolidate.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v4_2_morpheus_extract.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v4_2_persephone.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v4_2_pantheon_routing_audit.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v5_0_consolidated_at.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v5_0_morpheus_extract_run_memories.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v5_0_2_artemis_dedup.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v5_0_3_timestamp_tz_upgrade.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v5_1_0_deletion_log.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v5_2_0_nats_outbox_idempotency.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations_v5_2_2_fts_gin_index.sql",
        ...
        repo_path / "mnemos" / "db_migrations" / "migrations_v5_4_1_morpheus_extract_failures.sql",
        ...
        repo_path / "mnemos" / "db_migrations" / "migrations" / "0035_subscription_plans_date_aware.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations" / "0036_hive_agents_subscription_pools.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations" / "0037_deepseek_direct_provider_seed.sql",
        repo_path / "mnemos" / "db_migrations" / "migrations" / "0038_oauth_sessions_consultations.sql",
