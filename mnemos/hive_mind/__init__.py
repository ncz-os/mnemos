...
- worker_template — reference goose-worker daemon for self-driving agents

Identity: urn:agent:<kind>:<host>:<session_uuid>
Roles: claude-code/human/mnemos = orchestrators (submit+claim); opencode/goose/codex/hermes/claw-family/ic-engine = workers (claim only)
