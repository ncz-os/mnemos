...
CREATE TABLE IF NOT EXISTS deletion_requests (
    id VARCHAR(64) NOT NULL DEFAULT (UUID()), target_user_id VARCHAR(256) NOT NULL,
...
CREATE TABLE IF NOT EXISTS memory_archive (
    id VARCHAR(64) NOT NULL, archived_at DATETIME(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
