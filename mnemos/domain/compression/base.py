...
is orchestrated by mnemos.domain.compression.contest.run_contest (called from
mnemos.domain.compression.worker_contest.process_contest_queue), not by the engine
itself.
